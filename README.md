    ...
    Properties:
      ...
      Content: 
        Fn::Transform:
          Name: 'AWS::Include'
          Parameters:
            Location: 's3://your-bucket-name/Content.json'  # Update with your actual S3 bucket name
